...
class SignUp extends React.Component {
  ...
  handleSignupNameChange = (event) => {
      this.props.dispatch({ type: "email", payload: event.target.value })
  }
  handleSignupPasswordChange = (event) => {
      this.props.dispatch({ type: "password", payload: event.target.value })
  }
  render() {
    return (
      <div>
            ...
            <div className='card-body'>
              ...
              <div className='form-group col-md-8 offset-md-2 mt-3'>
                ...
                <input
                  ...
                  onChange={(event) => this.handleSignupNameChange(event)}
                  required
                />
              </div>
              <div className='form-group col-md-8 offset-md-2 mt-4'>
                <input
                  ...
                  onChange={(event) => this.handleSignupPasswordChange(event)}
                  required
                />
              </div>
